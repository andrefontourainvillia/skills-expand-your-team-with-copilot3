document.addEventListener("DOMContentLoaded", () => {
  ...
  function renderActivityCard(name, details) {
    ...
    const difficultyBadge = details.difficulty && difficultyColors[details.difficulty]
      ? `<span class="difficulty-badge" style="background-color: ${difficultyColors[details.difficulty].bg}; color: ${difficultyColors[details.difficulty].text}">
          ${details.difficulty}
        </span>`
      : "";
